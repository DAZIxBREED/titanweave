...
QEMU contains no physical Radeon. This freezes the C28 source/self-test/runtime/userspace safe-defer path and the real QEMU-exercised memory, firmware-validation/staging, and software-recovery behavior. It does **not** claim physical Radeon firmware silicon upload, physical ASIC reset, GPU page-table programming, Radeon DMA/bus mastering, rings/queues/fences, command submission, or physical GPU interrupt programming.
