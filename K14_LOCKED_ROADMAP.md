...
- **K14.C30 — Complete basic display engine** — **source-integrated; runtime qualification pending**. Connector/EDID/mode discovery, display pipes, framebuffer scanout, modesetting, page flip, hotplug and multi-display foundation.
